...
public class RecordsRecyclerListAdapter extends RecyclerView.Adapter<RecordsRecyclerListAdapter.ViewHolder> {
    ...
    public RecordsRecyclerListAdapter(ArrayList<RecordSourceBean> recordSourceBeans, Context context){
...
//            //数据发生变化，则数组重新声明
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate( R.layout.item_records_list,parent,false);
...
//        }
        ...
        holder.view_back.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        holder.view_back.setOnLongClickListener(new View.OnLongClickListener() {
...
//        holder.iv_item_records.setLayoutParams(new FrameLayout.LayoutParams(Tools.getScreenWidth(context)/2-Tools.dip2px(context,16),Tools.getScreenHeight(context)/2-Tools.dip2px(context,16)));
        ...
        holder.tv_item_file_size.setText(recordSourceBean.getFileSize()+"M");
        holder.tv_record_name.setText(recordSourceBean.getFileName());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tv_item_file_size;
        View view_back;

        public ViewHolder(View itemView) {
            super(itemView);
            iv_item_records =  itemView.findViewById(R.id.iv_item_records);
            iv_item_check =  itemView.findViewById(R.id.iv_item_check);
            tv_record_name = itemView.findViewById(R.id.tv_record_name);
            tv_item_duration =  itemView.findViewById(R.id.tv_item_duration);
            tv_item_file_size = itemView.findViewById(R.id.tv_item_file_size);
